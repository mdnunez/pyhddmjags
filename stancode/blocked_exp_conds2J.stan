...
parameters {
    ...
    real<lower=-4, upper=4> deltahier; // Hierarchical drift rate to correct
    real<lower=0, upper=1> terhier; // Hierarchical Non-decision time
    real<lower=0, upper=3> alphahier; // Hierarchical boundary parameter (speed-accuracy tradeoff)
    real<lower=0, upper=1> problapsehier; // Hierarchical lapse trial probability
