# regression_test_py3.py - Testing JAGS fits of HDDM models with participant-level regressors in JAGS using pyjags in Python 3
#
...
for p in range(nparts):
    for k in range(nconds):
        tempout = simulratcliff(N=ntrials, Alpha= alpha[p,k], Tau= ndt[p,k], 
